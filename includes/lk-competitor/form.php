...
<div id="gmaApllicationFormContainer">
    ...
    <div class="atentionCompetitor">
        <b>Внимание!</b> Заполняйте заявку строго по форме. Данные из формы будут использовать для печати
        грамот/дипломов/благодарностей, а также для заполнения адреса на конверте.
        Все процессы автоматизированы, это позволит ускорить отправку дипломов и грамот.
        <br /><b>Оплата участия производится после подачи заявки.</b>
        <br />
        <br />
        Спасибо! Победы на конкурсе!
    </div>
 ...
 foreach ($getCurrentSubSpecialties as $currentSubSpecialty):
	...
	$subSpecialty = $currentSubSpecialty['name'];?>
                    ...
                    <option style="display:none" value="<?php echo $id; ?>" data-parent-id="<?php echo $parent_id; ?>"
                        name="<?php echo $subSpecialty; ?>">
        ...
        <input type="number" min="1" max="15" name="timeCompositions" id="timeCompositions"> <span id="minutes">
            минут</span><br />
        ...
        <input type="text" name="Ваш e-mail" id="user_email"
            value="<?php echo wp_get_current_user()->user_email; ?>"><br />
        ...
        <div id='concertmaster' style="display:none">
            ...
            <input type="text" id="concertmaster_lastname" name="concertmaster_lastname"
                placeholder="Необязательно"><br />
            ...
            <input type="text" id="concertmaster_surname" name="concertmaster_surname"
                placeholder="Необязательно"><br />
        </div>
        <br />
        ...
        <div id="center"><br /><input type="submit" id="submit" value="Отправить" name="">
            ...
            <div id="loader" style="width:100%; height:100%; position:relative; margin:auto; display:none; opacity:0.5">
                <img
                    src="<?php global $plugin_url; echo $plugin_url . "/includes/lk-competitor/img/ajax-loader.gif" ?>">
            </div>
    ...
    <div id="oneMoreCompetitorContainer" style="display:none">
        ...
        <div class="infoForNewCompetitor">
            Мы получили вашу заявку!
            На email придёт письмо с подтверждением и реквизитами для оплаты вступительного взноса

            <br /><br />Если письмо не пришлом в течение часа,<br />напишите пожалуйста об этом на <a
                href="mailto:org@music-competition.ru">org@music-competition.ru</a>
        </div>
        <a href="javascript:oneMoreCompetitor();" id="oneMoreCompetitor" rel="noopener noreferrer">Заполнить еще одну
            заявку?</a>
        <br />
